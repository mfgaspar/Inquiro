...
WITH
 ...
 SET MEASURES AS {[Measures].[Type], [Measures].[Subtype], [Measures].[Job Name], [Measures].[Username], [Measures].[Status], [Measures].[Start Time], [Measures].[Finish Time], [Measures].[Spent Time]}
